...
It "omits" all rows with missing values, also known as a "listwise deletion". EG - It runs down the list deleting rows as it goes.
...
According to me, the Rplot1-2 makes more sense or is more informative. SInce, there are 3 clusters we can differntiate them more and on comparing we see 
