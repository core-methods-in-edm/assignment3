...
```{r}
# The 3-cluster group is more infromative. The trends are differnt.
```
...
```{r}
DF1 <- read.csv("cluster-class-data.csv", sep=",",head = TRUE)
names(DF1) <-c("duration","firstName","lastName","Cat","giff","monNYC","numSib","weekSport",
               "mileTotc","numfriendAndroid","numMovie","classSemester","statesVisited","cityGrow","stateGrow","countryGrow")
DF1 <- dplyr::select(DF1,4:13)
