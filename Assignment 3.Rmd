...
```{r}
degree(g1)
# From the betweenness, person 36, Yifei Zhang, is the most central person in this network. But the degree centrality gives 4 people including Yifei Zhang are the most central people.
```
```{r}
