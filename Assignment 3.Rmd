...
```{r}
ggplot(K6, aes(y=avg, x=week, color = cluster)) +
...
Grouping into 3 clusters is in formative. First, clusters is more comparative, because there are around 8 people in each cluster. Also, the former cluster-1 is broke into two sub-cluster, whose trend is totally different in the new picture.
...
D4<-filter(D3, Q2_1!=""&Q2_2!=""&Q2_3!=""&Q2_4!=""&Q2_5!=""&Q2_6!="")
...
ggplot(D6, aes(x=lon, y=lat,shape=as.factor(fit2$cluster), color=as.factor(fit3$cluster) )) +geom_point( size = 2)
