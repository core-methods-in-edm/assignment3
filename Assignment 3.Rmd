...
fit_person_class_matrix<-kmodes(person_class_matrix,4)
fit_person_class_matrix
...
DF35 <- DF5[row.names(DF5) %in% row.names(DC), ]
DC36 <- DC[row.names(DC) %in% row.names(DF35), ]
