...
plot(g, layout          = layout.fruchterman.reingold,
     ...
     vertex.label.color = "black",
     vertex.color       = "gainsboro")
# There is no obvious cluster of interest that correspond to clusters in the network. It indicates that students' interests are not related with the class they took because there is no clear pattern.
```
