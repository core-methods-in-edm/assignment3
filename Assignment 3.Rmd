...
plot(g,layout=layout.fruchterman.reingold,vertex.color=VERTEX$major,
     edge.arrow.size=.5,vertex.shape="circle",vertex.size=V(g)$vertex_degree*scale_factor,edge.curved=.1,vertex.frame.color="gray",vertex.label.cex=.8,)
V(g)$size <- V(g)$count.size*0.7
#major
