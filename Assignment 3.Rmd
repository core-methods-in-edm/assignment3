...
```{r}
plot(g,layout=layout.fruchterman.reingold, edge.arrow.size=.4, edge.curved=.1)
```

* The vertices are colored according to major
```{r}
plot(g,layout=layout.fruchterman.reingold, vertex.color="red")
```
...
#make all class letters capticals
...
#create a new variable containing is that will become our counts
C3$count <- 1
...
#centrality
```{r}
#calculate the degree centrality of th nodes, showing who has the most connections
