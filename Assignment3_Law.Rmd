...
-if remove these value, we might not have enough dataset - losing power for anlaysis 
...
- the 3 cluster group might be better as student are motived then the other two before w5 whereas the other clusters do not reveal that.
