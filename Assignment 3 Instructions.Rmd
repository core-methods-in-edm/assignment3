...
K1 <- read.csv("~/Desktop/HUDK 4050/Assignment#3Cluster/Class_Motivation.csv", header=TRUE)
...
##I think it's more informative,since it seems that the average motivation is distributed in three clusters and each cluster has the range of 7-9 observations, which is a good number.
...
Q7 - How many times do you play spo
rt each week?
